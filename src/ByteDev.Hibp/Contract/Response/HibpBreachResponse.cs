...
namespace ByteDev.Hibp.Contract.Response
{
    ...
    public class HibpBreachResponse
    {
        ...
        /// <summary>
        /// The total number of accounts loaded into the system. This is usually less than the total
        ...
        /// ordered string array of impacted data classes. 
        /// </summary>
        ...
        /// <summary>
        /// Indicates that the breach is considered fabricated. A fabricated breach is unlikely to have been hacked from the
        /// indicated website and usually contains a large amount of manufactured data. However, it still contains legitimate
        /// email addresses and asserts that the account owners were compromised in the alleged breach. 
        /// </summary>
        ...
        /// <summary>
        /// Indicates if the breach is considered a spam list. This flag has no impact on any other attributes but it means that
        /// the data has not come as a result of a security compromise. 
        /// </summary>
